...
data_param = \
    {'MR': {
        'path_to_search': '/home/gergely/Asztal',
        'filename_contains': 'mri.png'}}
...
vis_coordinates(image_2d, saving_name='/home/gergely/Asztal/output/image.png')
...
vis_coordinates(image_2d, coords, '/home/gergely/Asztal/output/uniform.png')
...
coords = np.concatenate(coords, axis=0)
vis_coordinates(image_2d, coords, '/home/gergely/Asztal/output/grid.png')
...
vis_coordinates(image_2d, coords, '/home/gergely/Asztal/output/grid_cropped.png')
