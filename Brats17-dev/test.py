...
test_data_param = {     'T1':    {'path_to_search': ('/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/LGG','/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/HGG'),
                         'filename_contains': 'T1', 'filename_not_contains': ('T1c','SP_T1','SP_T1c')},
                        'T1c':   {'path_to_search': ('/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/LGG','/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/HGG'),
                         'filename_contains': 'T1c', 'filename_not_contains': 'SP_T1c'},
                        'T2':    {'path_to_search': ('/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/LGG','/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/HGG'),
                         'filename_contains': 'T2', 'filename_not_contains': 'SP_T2'},
                        'Flair': {'path_to_search': ('/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/LGG','/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/HGG'),
                         'filename_contains': 'Flair', 'filename_not_contains': 'SP_Flair'},
                        'SP_T1': {'path_to_search': ('/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/LGG','/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/HGG'),
                         'filename_contains': 'SP_T1', 'filename_not_contains': 'SP_T1c'},
                        'SP_T1c': {'path_to_search': ('/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/LGG','/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/HGG'),
                         'filename_contains': 'SP_T1c'},
                        'SP_T2': {'path_to_search': ('/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/LGG','/media/hdd/Meddatabase//BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/HGG'),
                         'filename_contains': 'SP_T2'},
                        'SP_Flair': {'path_to_search': ('/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/LGG','/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/HGG'),
                         'filename_contains': 'SP_Flair'},
                        'label': {'path_to_search': ('/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/LGG','/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/HGG'),
                         'filename_contains': 'Label'}
                     }

test_data_param_soft = { 
                        'SP_T1': {'path_to_search': ('/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/LGG','/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/HGG'),
                         'filename_contains': 'SP_T1', 'filename_not_contains': 'SP_T1c'},
                        'SP_T1c': {'path_to_search': ('/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/LGG','/media/hdd/Meddatabase/BRATS2015_VSD/Dataset/Brats15_sp40_training/test_names/HGG'),
                         'filename_contains': 'SP_T1c'},
...
def test(config_file):
    #set logger
    set_logger('result15_sp40_full/res2.0/testing.log')
    tf.logging.info('testing started')
    ...
    if(config_net1):
        ...
        tf.logging.info('whole tumor else') 
    ...
    if(config_test.get('whole_tumor_only', False) is False):
        ...
        if(config_net2):
            ...
            tf.logging.info('tumor core else') 
        ...
        if(config_net3):
            tf.logging.info('enhanced tumor') 
            ...
            tf.logging.info('enhanced tumor else') 
    ...
    if(config_net1):
        ...
        tf.logging.info('3 else create session load trained models') 
    ...
    dataloader.load_data_nifty(test_data_param)
    ...
    for i in range(image_num):
        [temp_imgs, temp_weight, temp_name, img_names, temp_bbox, temp_size] = dataloader.get_image_data_with_niftyname(i)
        t0 = time.time()
        # 5.1, test of 1st network
        if(config_net1):
            print("shapes: ",data_shapes)
