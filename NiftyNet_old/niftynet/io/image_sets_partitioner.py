...
class ImageSetsPartitioner(object):
    ...
    def get_file_lists_by(self, phase=None, action='train'):
        ...
        if action and TRAIN.startswith(action):
            ...
            tf.logging.info('train_files: \n %s ',file_lists[0].MODALITY1.real)
            tf.logging.info('train files: \n %s ',file_lists[0].MODALITY2.real)
           
            if self.has_validation:
                file_lists.append(self.validation_files)
                tf.logging.info('validation files: \n %s ',file_lists[1].MODALITY1.real)
                tf.logging.info('validation files: \n %s ',file_lists[1].MODALITY2.real)                
